...
- **the break frequency, *ν<sub>b</sub>***. The break frequency represents the frequency above which the spectrum steepens steepens as a result of the energy loss mechanisms. 
